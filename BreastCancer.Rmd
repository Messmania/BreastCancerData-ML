...
library(bookdown) #for auto figure numbering
...
All the values indicate a lower value being closest to benignancy and 10 being the most malignant.
...
ggplot(plot_data, aes(d = D, m = p)) + 
	geom_roc(n.cuts = 12)+
  labs(subtitle="Fig 29. False positives and false negatives")
...
ggplot(plot_data, aes(d = D, m = p)) + 
	geom_roc(n.cuts = 12)+
  labs(subtitle="Fig 31. False positives and false negatives")
...
ggplot(plot_data_rf, aes(d = D, m = p)) +
	geom_roc(n.cuts = 12)+
  labs(subtitle="Fig 33. False positives and false negatives")
...
ggplot(plot_data_rf_mod, aes(d = D, m = p)) +
	geom_roc(n.cuts = 12)+
  labs(subtitle="Fig 34. False positives and false negatives")
...
ggplot(plot_data_rf, aes(d = D, m = p)) +
	geom_roc(n.cuts = 12)+
  labs(subtitle="Fig. 38. False positives and false negatives")
